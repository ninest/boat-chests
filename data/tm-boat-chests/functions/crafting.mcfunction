...
execute at @e[tag=chestboat_item_spruce] run summon minecraft:boat ~ ~1 ~ {Type:"spruce",Tags:["chestboat_spruce", "chestboat"],Passengers:[{id:"minecraft:chest_minecart",Tags:["chest"]}]}
...
execute at @e[tag=chestboat_item_birch] run summon minecraft:boat ~ ~1 ~ {Type:"birch",Tags:["chestboat_birch", "chestboat"],Passengers:[{id:"minecraft:chest_minecart",Tags:["chest"]}]}
...
execute at @e[tag=chestboat_item_jungle] run summon minecraft:boat ~ ~1 ~ {Type:"jungle",Tags:["chestboat_jungle", "chestboat"],Passengers:[{id:"minecraft:chest_minecart",Tags:["chest"]}]}
...
execute at @e[tag=chestboat_item_acacia] run summon minecraft:boat ~ ~1 ~ {Type:"acacia",Tags:["chestboat_acacia", "chestboat"],Passengers:[{id:"minecraft:chest_minecart",Tags:["chest"]}]}
...
execute at @e[tag=chestboat_item_dark_oak] run summon minecraft:boat ~ ~1 ~ {Type:"dark_oak",Tags:["chestboat_dark_oak", "chestboat"],Passengers:[{id:"minecraft:chest_minecart",Tags:["chest"]}]}
