...
for type in boat_types:
  ...
  print('execute at @e[tag=chestboat_item_' + type + '] run summon minecraft:boat ~ ~1 ~ {Type:"' + type + '",Tags:["chestboat_' + type + '", "chestboat"],Passengers:[{id:"minecraft:chest_minecart",Tags:["chest"]}]}')
